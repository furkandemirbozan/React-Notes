...
function Product() {
    ...
    const contentModal = (
        <>
            ...
            <Button btnText={loc ? "Ürünü Düzenle" : "Ürün Oluştur"} onClick={loc ? buttonUpdateFunc : buttonFunc} />
        </>
    )
    ...
    return (
        <div>
            ...
            {
                modal && <Modal content={contentModal} title={loc ? "Ürünü Düzenle" : "Ürün Oluştur"} />
            }
        </div>
    )
}
